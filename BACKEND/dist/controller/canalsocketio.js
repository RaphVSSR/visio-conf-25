import { ListeMessagesEmis, ListeMessagesRecus } from "../models/ListeMessages.js";
            ...
            socket.on("disconnect", async () => {
                try {
                    ...
                    if (!userId) {
                        ...
                        await User.model.updateOne({ _id: userId }, { disturb_status: "offline" });
...
//# sourceMappingURL=canalsocketio.js.map