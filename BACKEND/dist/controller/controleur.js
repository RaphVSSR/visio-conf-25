export default class Controleur {
    ...
    inscription(emetteur, liste_emission, liste_abonnement) {
        ...
        for (var key in liste_abonnement) {
            if (typeof this.listeAbonnement[liste_abonnement[key]] ==
                "undefined") {
    ...
    desincription(emetteur, liste_emission, liste_abonnement) {
        for (var key in liste_emission) {
            if (typeof this.listeEmission[liste_emission[key]] == "undefined") {
                console.log("ERREUR(controleur: le message en émission n'existe plus, on ne peut pas l'enlever: " +
                    liste_emission[key]);
            }
            else {
                if (typeof this.listeEmission[liste_emission[key]][emetteur.nomDInstance] == "undefined") {
                    console.log("ERREUR(controleur: le message en émission  " +
                        liste_emission[key] +
                    ...
                    if (this.verboseall || this.verbose) {
                        console.log("INFO(controleur: le message en émission " +
                            liste_emission[key] +
        ...
        for (var key in liste_abonnement) {
            if (typeof this.listeAbonnement[liste_abonnement[key]] ==
                ...
                if (typeof this.listeAbonnement[liste_abonnement[key]][emetteur.nomDInstance] == "undefined") {
                    ...
                    if (this.verboseall || this.verbose) {
                        console.log("INFO(controleur: le message en abonnement " +
                            liste_emission[key] +
                            " a été enlevé de la liste pour " +
                            emetteur.nomDInstance);
                    }
    ...
    envoie(emetteur, t) {
        if (this.verboseall || this.verbose) {
            console.log("INFO (controleur):le controleur a reçu de " +
                emetteur.nomDInstance +
                " :");
            console.log(t);
        }
        for (var item in t) {
            if (item != "id") {
                if (typeof this.listeEmission[item] == "undefined") {
                    console.log("ERREUR (controleur): Le message " +
                        item +
                        " envoyé par " +
                        emetteur.nomDInstance +
                ...
                if (this.listeEmission[item][emetteur.nomDInstance] ==
                    "undefined") {
                    console.log("ERREUR (controleur): Le message " +
                        item +
                        " envoyé par " +
                ...
                for (var recepteurkey in this.listeAbonnement[item]) {
                    ...
                    if (typeof t.id != "undefined")
                        T.id = t.id;
                    if (this.verboseall || this.verbose) {
                        console.log("INFO (controleur): on envoie " +
                            item +
                            " à " +
                            recepteurkey);
                    }
